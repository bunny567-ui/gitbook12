...
*   **Field Type:**\
    ...
    * **Text:**\
      Use this type when the field accepts free text input. You can enter values directly, which will be updated in the corresponding JIRA field.

    <figure><img src="../../../.gitbook/assets/image (7).png" alt=""><figcaption></figcaption></figure>

    *   **List:**\
        You can maintain a predefined list of values for a field, allowing users to select the appropriate option from the list.
