...
* [ReleaseOwl Admin Guide](README.md)
  * [General Administration](releaseowl-admin-guide/general-administration/README.md)
    ...
    * [Credential Management](releaseowl-admin-guide/general-administration/credential-management/README.md)
      * [Transport Manager Credential](releaseowl-admin-guide/general-administration/credential-management/transport-manager-credential.md)
      * [SAP Analytics Cloud](releaseowl-admin-guide/general-administration/credential-management/sap-analytics-cloud.md)
      * [SAP Datasphere](releaseowl-admin-guide/general-administration/credential-management/sap-datasphere.md)
      * [SAP Cloud Environment](releaseowl-admin-guide/general-administration/credential-management/sap-cloud-environment.md)
      ...
      * [Fresh Service](releaseowl-admin-guide/general-administration/credential-management/fresh-service.md)
      * [CRT](releaseowl-admin-guide/general-administration/credential-management/crt.md)
      * [4Me](releaseowl-admin-guide/general-administration/credential-management/4me.md)
      * [Docusign](releaseowl-admin-guide/general-administration/credential-management/docusign.md)
      * [Azure DevOps](releaseowl-admin-guide/general-administration/credential-management/azure-devops.md)
      * [Service Now](releaseowl-admin-guide/general-administration/credential-management/service-now.md)
      * [Ui Path](releaseowl-admin-guide/general-administration/credential-management/ui-path.md)
      * [Docusign](releaseowl-admin-guide/general-administration/credential-management/docusign-1.md)
...
* [ReleaseOwl User Guide](releaseowl-user-guide/README.md)
  * [Change Management](releaseowl-user-guide/change-management/README.md)
    ...
    * [User Dependencies](releaseowl-user-guide/change-management/user-dependencies.md)
  * [SAP On-Premise](releaseowl-user-guide/sap-on-premise/README.md)
    ...
    * [Transport of Copies](releaseowl-user-guide/sap-on-premise/transport-of-copies.md)
    * [Retrofit & Conflict Resolution](releaseowl-user-guide/sap-on-premise/retrofit-and-conflict-resolution.md)
    * [gCTS](releaseowl-user-guide/sap-on-premise/gcts.md)
    * [Build pipeline support for onPrem Fiori](releaseowl-user-guide/sap-on-premise/build-pipeline-support-for-onprem-fiori.md)
    * [Transport Management Actions](releaseowl-user-guide/sap-on-premise/transport-management-actions.md)
    * [Parallel Landscape Configuration](releaseowl-user-guide/sap-on-premise/parallel-landscape-configuration.md)
    * [Transport Validation and Analysis Reports](releaseowl-user-guide/sap-on-premise/transport-validation-and-analysis-reports.md)
  * [SAP BTP](releaseowl-user-guide/sap-btp/README.md)
    ...
    * [Build Pipelines](releaseowl-user-guide/sap-btp/build-pipelines/README.md)
      * [Download Artifact](releaseowl-user-guide/sap-btp/build-pipelines/download-artifact.md)
      * [Build Changes](releaseowl-user-guide/sap-btp/build-pipelines/build-changes.md)
      * [SonarQube Report](releaseowl-user-guide/sap-btp/build-pipelines/sonarqube-report.md)
  ...
  * [SAP Integration Suite](releaseowl-user-guide/sap-integration-suite/README.md)
    * [Administration](releaseowl-user-guide/sap-integration-suite/administration/README.md)
      ...
      * [Integration Environment Registration](releaseowl-user-guide/sap-integration-suite/administration/cloud-environment-registration.md)
    * [CPI Governance Rules](releaseowl-user-guide/sap-integration-suite/cpi-governance-rules.md)
    * [CPI Management](releaseowl-user-guide/sap-integration-suite/cpi-management/README.md)
      * [Synchronize CPI Artifacts](releaseowl-user-guide/sap-integration-suite/cpi-management/synchronize-cpi-artifacts.md)
      * [Artifact Versions](releaseowl-user-guide/sap-integration-suite/cpi-management/artifact-versions.md)
      * [CPI Artifact Comparison](releaseowl-user-guide/sap-integration-suite/cpi-management/cpi-artifact-comparison.md)
      * [Backup & Rollback](releaseowl-user-guide/sap-integration-suite/cpi-management/backup-and-rollback.md)
  ...
  * [SAP Cloud Identity Services](releaseowl-user-guide/sap-cloud-identity-services/README.md)
    * [Administration](releaseowl-user-guide/sap-cloud-identity-services/administration/README.md)
      ...
      * [Environment Registration](releaseowl-user-guide/sap-cloud-identity-services/administration/environment-registration.md)
  * [CPI Web Auth with SAP Passport](releaseowl-user-guide/cpi-web-auth-with-sap-passport/README.md)
    * [Administration](releaseowl-user-guide/cpi-web-auth-with-sap-passport/administration/README.md)
      * [Credential Management](releaseowl-user-guide/cpi-web-auth-with-sap-passport/administration/credential-management.md)
      * [Environment Registration](releaseowl-user-guide/cpi-web-auth-with-sap-passport/administration/environment-registration.md)
  * [SAP API Management](releaseowl-user-guide/sap-api-management/README.md)
    * [Adminstration](releaseowl-user-guide/sap-api-management/adminstration/README.md)
  ...
  * [SAP Public Cloud](releaseowl-user-guide/sap-public-cloud/README.md)
    * [Administration](releaseowl-user-guide/sap-public-cloud/administration/README.md)
      ...
      * [Public Cloud Environment Registration](releaseowl-user-guide/sap-public-cloud/administration/cloud-environment-registration.md)
    * [Public Cloud Transport Management](releaseowl-user-guide/sap-public-cloud/public-cloud-transport-management.md)
    * [Validation Report](releaseowl-user-guide/sap-public-cloud/validation-report.md)
    * [Deployment Report](releaseowl-user-guide/sap-public-cloud/deployment-report.md)
    * [Central Business Configuration(CBC)](releaseowl-user-guide/sap-public-cloud/central-business-configuration-cbc.md)
  * [SAP Analytics Cloud](releaseowl-user-guide/sap-analytics-cloud/README.md)
    ...
    * [Analytics Cloud Management](releaseowl-user-guide/sap-analytics-cloud/analytics-cloud-management.md)
    * [Working with UserStories](releaseowl-user-guide/sap-analytics-cloud/working-with-userstories.md)
  ...
  * [SAP ABAP Cloud](releaseowl-user-guide/sap-abap-cloud-1/README.md)
    ...
    * [RAP Application](releaseowl-user-guide/sap-abap-cloud-1/rap-application/README.md)
      * [ATC Report](releaseowl-user-guide/sap-abap-cloud-1/rap-application/atc-report.md)
      * [ABAP Unit Test](releaseowl-user-guide/sap-abap-cloud-1/rap-application/abap-unit-test.md)
    * [Working with User Stories](releaseowl-user-guide/sap-abap-cloud-1/working-with-user-stories.md)
  * [Working with Release Packages](releaseowl-user-guide/working-with-release-pipelines/README.md)
    * [Create Release Package with CPI](releaseowl-user-guide/working-with-release-packages/create-release-package-with-cpi.md)
    * [Create Release Package with Transports](releaseowl-user-guide/working-with-release-packages/create-release-package-with-transports.md)
    * [Create Release Package with BTP](releaseowl-user-guide/working-with-release-packages/create-release-package-with-btp.md)
  * [Working with Release Pipelines](<releaseowl-user-guide/working-with-release-pipelines/README (1).md>)
    * [Pipeline Tasks](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/README.md)
      * [Approval Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/approval-task.md)
      * [Callout Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/callout-task.md)
      * [Manual Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/manual-task.md)
      * [User Story Status Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/user-story-status-task.md)
      * [Test Execution Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/test-execution-task.md)
      * [Message Listener Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/message-listener-task.md)
      * [GCTS Merge Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/gcts-merge-task.md)
      * [GCTS Activate Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/gcts-activate-task.md)
      * [GCTS Switch Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/gcts-switch-task.md)
      * [Pull Request Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/pull-request-task.md)
      * [Merge Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/merge-task.md)
      * [Build Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/build-task.md)
      * [Validation Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/validation-task.md)
      * [Import via Toc Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/import-via-toc-task.md)
      * [Transport Retrofit Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/transport-retrofit-task.md)
      ...
      * [Validation Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/validation-task-1.md)
      ...
      * [Stop Condition Task](releaseowl-user-guide/working-with-release-pipelines/pipeline-tasks/stop-condition-task.md)
    * [Use Cases](releaseowl-user-guide/working-with-release-pipelines/use-cases/README.md)
      ...
      * [Automated RAP Applications](releaseowl-user-guide/working-with-release-pipelines/use-cases/automated-rap-applications.md)
  ...
  * [Test Automation](releaseowl-user-guide/test-automation/README.md)
    ...
    * [Tosca Integration](releaseowl-user-guide/test-automation/tosca-integration/README.md)
      * [Tosca Cloud](releaseowl-user-guide/test-automation/tosca-integration/tosca-cloud.md)
      * [Tosca Server](releaseowl-user-guide/test-automation/tosca-integration/tosca-server.md)
    * [UiPath](releaseowl-user-guide/test-automation/uipath.md)
