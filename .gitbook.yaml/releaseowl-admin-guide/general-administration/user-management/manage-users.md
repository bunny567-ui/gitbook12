...
Select the appropriate option based on the type of data you want to import.

In the **Import Details** section, click the **Browse** button to select the file from your local system. After selecting the file, proceed with the import process.
